...
// ─ App-level publish state (single state machine) ────────
// All apps live in the publisher's local pool by default. The 5 states
// below describe the journey toward the PUBLIC pool. Apps that never get
// published just stay in `not-published` forever — internal use only,
// requires the publisher to also hold an ISO contract to actually deploy.
const APP_STATUS = {
  "not-published": { label: "Not Published",     tone: "neutral", description: "In your local pool. Visible only to your organization." },
  "awaiting-review": { label: "Awaiting Review", tone: "warning", description: "Submitted to Admin. Average turnaround 1–2 business days." },
  "rejected":      { label: "Changes Requested", tone: "danger",  description: "Admin returned the app with notes. Address them and resubmit." },
  "published":     { label: "Published",         tone: "success", description: "Live in the public pool. ISO companies can subscribe." },
  "unpublished":   { label: "Unpublished",       tone: "neutral", description: "Manually withdrawn from the public pool. Existing subscribers keep their snapshot; new subscriptions are blocked. Re-publish does not require Admin review." },
  "archived":      { label: "Archived",          tone: "neutral", description: "Archived. New subscriptions disabled." },
};
...
// REVIEW_STATE is intentionally removed in the new model — the publish state
// machine on APP_STATUS folds in what review state used to convey.
...
// rest are owned by Acme Software, our default ISV tenant.
...
// ─── App review activity (Admin-side audit trail) ──────────
// Each entry: { kind, at, actor, note? }. Kinds:
//   submitted  — ISV pushed metadata to Admin for review
//   approved   — Admin signed off; app entered the public pool
//   rejected   — Admin returned the app with notes
//   resubmitted — ISV addressed feedback and re-pushed
//   internal-flip — ISV switched an internal-only app to "Publish to pool"
//                   (triggered a new submission)
//   metadata-change — ISV edited name/category/description while approved
//                   (queues a new submission once saved)
const APP_REVIEW_ACTIVITY = {
  "pos": [
    { kind: "submitted", at: "Sep 14, 2023", actor: "M. Hassan",
      note: "Initial submission for app pool entry." },
    { kind: "approved",  at: "Sep 16, 2023", actor: "Admin · J. Park",
      note: "Approved. Category, description and screenshots all consistent." },
  ],
  "inventory": [
    { kind: "submitted", at: "Jan 08, 2024", actor: "M. Hassan" },
    { kind: "approved",  at: "Jan 09, 2024", actor: "Admin · J. Park" },
  ],
  "loyalty": [
    { kind: "submitted", at: "Nov 02, 2023", actor: "M. Hassan" },
    { kind: "approved",  at: "Nov 06, 2023", actor: "Admin · K. Vu" },
  ],
  "reporting": [
    { kind: "submitted", at: "Feb 20, 2024", actor: "M. Hassan" },
    { kind: "approved",  at: "Feb 22, 2024", actor: "Admin · J. Park" },
  ],
  "catalog": [
    { kind: "submitted", at: "Mar 11, 2024", actor: "M. Hassan" },
    { kind: "approved",  at: "Mar 12, 2024", actor: "Admin · K. Vu" },
  ],
  "delivery": [
    { kind: "submitted", at: "May 12, 2026", actor: "M. Hassan",
      note: "First submission — order-ahead/curbside flow." },
  ],
  "timeclock": [
    { kind: "submitted", at: "Aug 05, 2023", actor: "L. Tremblay" },
    { kind: "rejected",  at: "Aug 07, 2023", actor: "Admin · J. Park",
      note: "Description mentions \"NFC clock-in\" but screenshots show only PIN flow. Update copy to match the actual feature set." },
    { kind: "resubmitted", at: "Aug 09, 2023", actor: "L. Tremblay",
      note: "Updated description and added an NFC badge screenshot." },
    { kind: "approved",  at: "Aug 10, 2023", actor: "Admin · J. Park" },
  ],
  "giftcard": [
    // Not yet submitted — used internally only.
  ],
  "tablemanager": [
    { kind: "created", at: "May 13, 2026", actor: "M. Hassan",
      note: "App registered. Upload an APK to enable submission." },
  ],
};
