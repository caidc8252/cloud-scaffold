...
function Textarea({
  ...
  const textarea = (
    <textarea
      data-slot="textarea"
      className={cn(
        "flex field-sizing-content min-h-16 w-full rounded-lg border border-line-default bg-surface-2 p-[10px_12px] text-[12.5px] font-mono resize-y transition-colors outline-none placeholder:text-content-tertiary focus-visible:border-line-focus focus-visible:ring-3 focus-visible:ring-line-focus/30 disabled:cursor-not-allowed disabled:bg-surface-3 disabled:opacity-50 aria-invalid:border-error-strong aria-invalid:ring-3 aria-invalid:ring-error/20",
        className
      )}
      maxLength={maxLength}
      value={value}
